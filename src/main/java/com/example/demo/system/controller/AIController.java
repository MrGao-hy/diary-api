...
//    private String BAIDU_SECRET_KEY;
    ...
    @ApiOperation(value = "老图片变清晰")
    @PostMapping("/image/inFocus")
    public Result imageInFocusApi(@RequestBody String url) {
    ...
    @ApiOperation(value = "人像动漫化, 图片地址转化base64")
    @PostMapping("/base64/generative/animation")
    public Result base64PortraitsGenerateAnimeCharacters(@RequestBody String url) {
        String timestamp = String.valueOf(System.currentTimeMillis() / 1000);
        String action = "FaceCartoonPic";
        String host = "ft.tencentcloudapi.com";
        String version = "2020-03-04";
